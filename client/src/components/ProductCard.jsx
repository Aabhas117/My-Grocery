...
const ProductCard = ({ product, goToCategory = false }) => {
          ...
          <div className="flex items-end justify-between mt-3">
            ...
            >
              {!cartItems[product._id] ? (
                ...
                <div className="flex items-center justify-center gap-2 md:w-20 w-16 height: 34px bg-primary/25 rounded select-none">
                  <button
                    onClick={() => {
